...
#### Approach & Reasoning:
For the Python project, __I aimed to make it scalable and robust__, although I recognize the project’s simple premise doesn’t require such complexity. I implemented a transform function to allow changes to the sales objects, __and designed a load function to insert data into BigQuery__. 
